...
function detailsmodal(id){
    ...
    .done(function(data) {
            var tableau_produit="";
            tableau_produit +='<div class="modal-dialog modal-lg"><div class="modal-content"><div class="modal-header"><button class="close" type="button" data-dismiss="modal" aria-label="close"><span aria-hidden="true">&times;</span></button><h4 class="modal-title text-center" style="color: #faa732;">DETAILS</h4>';
            ...
            tableau_produit +='</div></form></li></ul></div></div><div class="modal-footer"><button class="btn btn-default" data-dismiss="modal">Fermer</button><button class="btn btn-warning" onclick="add_to_cart();return false;"><span class="icon-shopping-cart"></span>Ajouter</button></div></div></div> '; 
          // affectation des produits dans l'id
            jQuery('#details-modal').append(tableau_produit).modal('show');
