<!-- Sidebar ================================================== -->
	<div id="sidebar" class="span3">
		<div class="well well-small"><a id="myCart" href="index.php?p=panier"><span class="badge badge-warning"><span class="icon-shopping-cart"></span> <span class="total-count"></span> Élément(S) </span><span class="badge badge-warning pull-right"><span class="total-panier" id="prix_total"></span> Gdes</span></a></div>
