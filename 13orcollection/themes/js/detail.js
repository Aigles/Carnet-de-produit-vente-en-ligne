    ...
    .done(function(data) { 
        var tableau_produit="";
            ...
            tableau_produit +='<button type="button" class="btn btn-large btn-warning pull-right "  id="ajouter-panier"  data-image="'+data.caracteristic[0].image+'" data-nom="'+data.nom+'" data-prix="'+data.caracteristic[0].prix+'">Ajouter</button>';
            // ========== partie Size =============
