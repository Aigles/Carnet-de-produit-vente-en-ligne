    ...
    .done(function(data) { 
        var tableau_produit="";
            ...
            tableau_produit +='<button type="button" class="btn btn-large btn-warning pull-right "  id="ajouter-panier" data-nom="'+data.nom+'" data-prix="'+data.caracteristic[0].prix+'">Ajouter</button>';
            // ========== partie Size =============
            ...
            tableau_produit +='</select><input type="number" class="span1"  id="quantity" name="quantity" placeholder="Quantité." max="'+data.nbre_en_stock+'" min="1"/>  </div><hr class="soft"/><h5>Élement(s) en stock :  <span class="badge badge-warning">'+data.nbre_en_stock+'</span></h5><label class="control-label for="couleur"><span>Couleur :</span></label><div class="controls">';
