...
if (page == '' || page == 'product_details.php') {
  $.ajax({
    ...
    tableau_produit += '<button type="button" class="btn btn-warning pull-right ajouter-panier"  data-image="' + data.caracteristic[0].image + '" data-nom="' + data.nom + '" data-prix="' + data.caracteristic[0].prix + '">Ajouter <span class="icon-shopping-cart"></span></button>';
    // ========== partie Size =============
