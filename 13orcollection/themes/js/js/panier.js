...
function afficherpanier() {
  ...
  output +='<button type="button" class="btn btn-success" onclick="commande();"><a href="index.php?p=commande"> Passer la commande <span class="icon-shopping-play"></span></a></td></tr>';
