...
//alert("ListeVetement.html")
    ...
    var tableau_produit="";
     ...
     tableau_produit+='<div class="caption"><h5>'+produit.nom+'</h5> <p>'+produit.description+'. </p><h4 style="text-align:center"><a  href="product_details.html?prodid='+produit.id+'" class="btn btn-warning">Ajouter <i class="icon-shopping-cart"></i></a> <a class="btn btn-warning" href="product_details.html?prodid='+produit.id+'">voir</a></h4>';
