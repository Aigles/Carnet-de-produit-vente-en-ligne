...
function detailsmodal(id){
    ...
    .done(function(data) {
            ...
            tableau_produit +='</div><div class="modal-body" id="vetement_details"> <div class="container-modifier"><ul class="thumbnails" style="width:760px; margin-left:10px;"><span id="modal_errors" class="bg-danger"></span><li class="span" style=" width:300px;"><div class="center-block"><img style="max-width:300px; height: 320px;" src="'+data.caracteristic[0].image+'" class="taille-img" alt="Levis Jean" class="details img-responsive"></div>';
