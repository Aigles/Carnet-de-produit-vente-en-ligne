...
<head>
    ...
    -->
    <meta charset="utf-8">
    <title>F13 or Collection | Admin</title>
        ...
        <div class="col-sm-2 col-lg-2">
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu" id="nav_menu">
...
<div class="row">
                ...
                <form role="form">
                  ...
                  <div class="box col-md-6">  
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nom-poduit" placeholder="Entrer le nom d'un Vetement">
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Description</label>
                        <textarea type="number" class="form-control autogrow" id="description-poduit" placeholder="Entrer la description d'un Vetement"></textarea>
                    </div>
                    <div class="form-group">
                        <label for="exampleInputPassword1">Nombre de Vetements vendus</label>
                        <input type="number" class="form-control" id="nb-vendu" placeholder="Entrer le nombre de Vetements vendus ">
                    </div>
                </div>
                <div class="box col-md-6">  
                    <div class="form-group">
                        <label for="exampleInputPassword1">Nombre de Vetements en stock</label>
                        <input type="number" class="form-control" id="nb-poduit" placeholder="Entrer le nombre de Vetements en stock">
                    </div>
                          <div class="form-group">
                        <label for="exampleInputPassword1">Rabais(%) </label>
                        <input type="number" class="form-control" id="nb-rabais" placeholder="Entrer un Rabais(%)">
                    </div>
                     <div class="form-group">
                        ...
                        <input data-no-uniform="true" type="checkbox" class="iphone-toggle" id='toggle-two'>
                         ...
                         <div class="row" id="tableday-id">
                          ...
                          <div class="col-md-4 col-lg-4">
                              <input class="form-control" id="h-start-time" type="time" aria-describedby="nameHelp" placeholder="8:00 AM" name="start-time" value="8:00" >
                              </div>
                              <div class="col-md-4 col-lg-4">
                                  <input class="form-control" id="h-end-time" type="time" aria-describedby="nameHelp" placeholder="Heure fermeture" name="end-time">
                                  </div>
                           </div> -->
                          </div>
                          <div class="row">
                           <div class="form-group">
                              ...
                              <button type="button" id="add" class="  btn btn-success" key="ajouter_ligne">ajouter ligne</button></br>
                              </div>
                              <div class="col-md-3">
                              <input class=" form-control" id="ligne" type="number" aria-describedby="nameHelp" placeholder="" name="ligne" value="1"></br>
                              </div></br>
                          </div>
                            </div>
                            <div class="row">
                    ...
                    <button type="button" class="btn btn-default" onclick="Modifierproduit()">Modifier</button></br>
                </div>
            </div>
            </div>
                    </div>
    ...
    <footer class="row">
        <p class="col-md-9 col-sm-9 col-xs-12 copyright">&copy; <a href="http://usman.it" target="_blank">Aigles</a>- 2018</p>

        <p class="col-md-3 col-sm-3 col-xs-12 powered-by">Propulse par: <a
                href="http://usman.it/free-responsive-admin-template">13 or Collection</a></p>
    </footer>

</div><!--/.fluid-container-->

<!-- external javascript -->
<script src="bower_components/jquery_2/dist/jquery.min.js"></script>
<script src="js/menu/loadmenu.js"></script>
