...
$.ajax({ url: fullUrl+"utilisateur",
    ...
    Accept : "application/json;charset=UTF-8"
        ...
        $.each( data, function( key, value ) {     
            ...
            dataTable_tr+='<td>';
            dataTable_tr+='<a href="index.php?p=editerPersonnel&pid='+value.id+'" class="btn btn-primary btn-xs" title="Modifier cet enregistrement"><i class="fa fa-pencil" >Modifier</i></a>&nbsp;';
