            ...
            <form class="form-horizontal"  method="post">
                <fieldset>
                    <div class="input-group input-group-lg">
                        ...
                        <input type="text" class="form-control" placeholder="Entrer votre email" id="con_email">
                    </div>
                    <div class="clearfix"></div><br>

                    <div class="input-group input-group-lg">
                        <span class="input-group-addon"><i class="glyphicon glyphicon-lock red"></i></span>
                        <input type="password" class="form-control" placeholder="Mot de passe" id="conn_password">
                    </div>
                    ...
                    <p class="center col-md-5">
                        <button type="button" class="btn btn-primary" onclick="connection();">se connecter</button>
                    </p>
                </fieldset>
            </form>
        </div>
