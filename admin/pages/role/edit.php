...
<div>
    <ul class="breadcrumb">
       ...
       <li>
           <a href="#">Modification d'un role</a>
       </li>
    </ul>
</div>
    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                <h2><i class="glyphicon glyphicon-edit"></i> Modifier un role</h2>
                    ...
                    <div class="row">
                        <div class="form-group">
                            <div class="col-md-offset-9">
                                ...
                                <button type="button" class="btn btn-primary" onclick="modifierRolle()">Enregistrer</button>
                            </div>
                        </div>
                    </div>
                </form>
...
<script src="js/Role/modifier.js"></script>
