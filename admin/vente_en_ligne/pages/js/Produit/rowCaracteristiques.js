...
function createRow(row){
    ...
    dataTable_tf+= '<div class="col-md-12 " id="diva-'+row+'"><input class="btn btn" id="start-'+row+'" type="file" name="file" onchange="previewFile(\'#divimg-'+row+'\',\'#diva-'+row+'\')"></br></div></div> ';
    dataTable_tf+= '<div class="col-md-3"><div class="col-md-12 " id="divimgg-'+row+'"><img class="" id="start-'+row+'" src="" style="height:130px;"></br></div> ';
    dataTable_tf+= '<div class="col-md-12 " id="divaa-'+row+'"><input class="btn btn" id="startt-'+row+'" type="file" name="file" onchange="previewFile(\'#divimgg-'+row+'\',\'#divaa-'+row+'\')"></br></div></div> ';
    dataTable_tf+= '<div class="col-md-6 "><div class="col-md-6 " id="divb-'+row+'"><input class="form-control" id="couleur-'+row+'" type="text" aria-describedby="nameHelp" placeholder="entrer la couleur" name="couleur" ></br></div> ';
    dataTable_tf+= '<div class="col-md-6 " id="divc-'+row+'"><input class="form-control" id="size-'+row+'" type="number" aria-describedby="nameHelp" placeholder="entrer la taille " name="size" ></br></div> ';
    dataTable_tf+= '<div class="col-md-6 " id="divd-'+row+'"><input class="form-control" id="prix-'+row+'" type="number" aria-describedby="nameHelp" placeholder="entrer le prix" name="prix" ></br></div> ';
    dataTable_tf+= '<div class="col-md-4" id="dive-'+row+'"><input class="form-control" id="qte-'+row+'" type="number" aria-describedby="nameHelp" placeholder="quantite" name="quantite"></br></div> ';
